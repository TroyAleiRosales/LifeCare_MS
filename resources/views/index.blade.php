@extends('layouts.app')
@section('content')
<div id="home" class="parallax first-section wow fadeIn" data-stellar-background-ratio="0.3" style="background-image:url('images/home-bg.jpg');" {{ $app = App\Models\settings::latest()->first() }}>
   <div class="container">
      <div class="row">
         <div class="col-md-12 col-sm-12">
            {{-- <div class="text-contant">
               <h2>
                  <span class="center"><span class="icon"><img src="{{ config('app.url') }}images/icon-logo.png" alt="#" /></span></span>

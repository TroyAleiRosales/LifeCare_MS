                    ...
                    <div class="header-info">
                        <div class="info-inner">
                            ...
                            <span class="iconcont"><a
                                    href="tel:{{ $settings["phone"] ?? '0980 675 1341' }}">{{ $settings["phone"] ?? '0980 675 1341' }}</a></span>
                        </div>
                        <div class="info-inner">
                            <span class="icontop"><i class="fa fa-envelope" aria-hidden="true"></i></span>
                            <span class="iconcont"><a data-scroll
                                    href="mailto:{{ $settings["email"] ?? 'email@test.com' }}">{{ $settings["email"] ?? 'email@test.com' }}</a></span>
                        </div>
                        <div class="info-inner">
